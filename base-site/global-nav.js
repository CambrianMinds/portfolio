...
(function() {
    ...
    const projectDirs = [
        ...
        '/maria-page/', '/mathematics-site/', '/manual-site/'
    ];
    ...
    const links = [
        ...
        { name: 'The Mathematics of Connection', url: rootPrefix + 'mathematics-site/index.html' },
        { name: "Owner's Manual for the Meat Suit", url: rootPrefix + 'manual-site/index.html' },
